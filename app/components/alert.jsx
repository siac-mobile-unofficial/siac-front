...
export default function AuthorizedAlert() {
  ...
  return SaveUser().getBoolean("user.authorized") ? (
    <></>
  ) : (
    <Modal
      ...
      <View style={style.authorized}>
        <View style={style.authorized_body}>
          <Text style={{ fontSize: 18 }}>
            Esse aplicativo foi desenvolvido de um estudante para outros
            estudantes, seus dados não são amarzenados em nenhum sistema.
          </Text>
